	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--secondary) / 0.5)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--secondary) / 0.8)' }
				},
				'pulse-slow': {
					'0%, 100%': { opacity: '1' },
					'50%': { opacity: '0.5' }

-- Update trigger to use 'paid' instead of 'completed'
...
-- Add comment
COMMENT ON FUNCTION public.block_slot_on_payment() IS 'Automatically blocks service availability slots when a booking payment is paid';
-- Insert sample organizers, venues, and events with proper enum casting
DO $$
DECLARE
  sample_user_id uuid;
BEGIN
  ...
  SELECT 
    ...
    e.sales_start_datetime::timestamptz,
    e.sales_end_datetime::timestamptz
  FROM public.organizers o
  ...
  CROSS JOIN (
    VALUES
      ...
      ('Rainbow Venues', 'Royal Gardens Wedding Venue', 'Summer Music Festival', 'Exclusive outdoor music festival featuring top regional artists', 'festival', '2025-10-25 10:00:00+02', '2025-10-25 22:00:00+02', true, false, 'Africa/Harare', ARRAY['https://images.unsplash.com/photo-1519225421980-715cb0215aed'], 10, '2025-10-01 00:00:00+02', '2025-10-24 23:59:00+02'),
      ('Victoria Falls Events Co', 'The Boma - Zimbabwe', 'Traditional Dinner Theater', 'Immersive theatrical dining experience with traditional entertainment', 'theater', '2025-11-30 18:00:00+02', '2025-11-30 23:00:00+02', true, false, 'Africa/Harare', ARRAY['https://images.unsplash.com/photo-1533777857889-4be7c70b33f7'], 6, '2025-10-30 00:00:00+02', '2025-11-30 12:00:00+02'),
      ('Mutare Conference Centre', 'Leopard Rock Convention Hall', 'Eastern Highlands Business Forum', 'Regional business networking and development conference', 'conference', '2025-12-10 08:30:00+02', '2025-12-11 17:00:00+02', true, false, 'Africa/Harare', ARRAY['https://images.unsplash.com/photo-1511795409834-ef04bbd61622'], 4, '2025-11-01 00:00:00+02', '2025-12-09 23:59:00+02'),
      ('Elite Events Zimbabwe', 'Cresta Lodge Harare', 'New Year''s Eve Club Night', 'Elegant black-tie celebration to welcome 2026', 'club_night', '2025-12-31 20:00:00+02', '2026-01-01 02:00:00+02', true, true, 'Africa/Harare', ARRAY['https://images.unsplash.com/photo-1467810563316-b5476525c0f9'], 4, '2025-11-01 00:00:00+02', '2025-12-30 23:59:00+02'),
  ...
  WHERE o.business_name = e.organizer_name 
    AND v.name = e.venue_name;

...
interface AddTripTicketTypeFormProps {
  tripId: string;
  onSuccess: () => void;
}

export const AddTripTicketTypeForm = ({ tripId, onSuccess }: AddTripTicketTypeFormProps) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-3 border rounded-lg p-4 bg-muted/50">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input id="ticket_name" name="ticket_name" placeholder="e.g., Standard Seat" required />
        </div>
        <div>
      ...
      <div>
        <Label htmlFor="quantity">Available Seats *</Label>

...
interface AddTripAddonFormProps {
  tripId: string;
  onAddonAdded: () => void;
}

export const AddTripAddonForm: React.FC<AddTripAddonFormProps> = ({ tripId, onAddonAdded }) => {
  ...
  return (
    <Card className="mt-4">
      <CardHeader>
        <CardTitle className="text-lg">Add New Trip Add-On</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="Extra Luggage, Meal, Premium Seat, etc."
              required
            />
          </div>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="transport">Extra Luggage</SelectItem>

...
const NewsletterSection = () => {
  ...
  return (
    <section className="py-12 md:py-20 lg:py-24 bg-gradient-to-br from-secondary/10 via-background to-primary/10 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-10 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-foreground to-secondary bg-clip-text text-transparent">
          ...
          {/* Benefits */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-10 md:mb-12 lg:mb-16">
          ...
          {/* Newsletter Form */}
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-border shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-4 md:mb-6">
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    disabled={isLoading}
                    className="pl-10 sm:pl-12 h-12 sm:h-14 text-base sm:text-lg bg-background border-border focus:border-primary"
                  />
                </div>
                <Button 
                  variant="default" 
                  size="lg" 
                  className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg font-semibold hover-scale"

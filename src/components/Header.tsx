...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 bg-white/20 md:bg-white/10 backdrop-blur-md border-b border-white/30 md:border-white/20 shadow-lg md:shadow-none">
